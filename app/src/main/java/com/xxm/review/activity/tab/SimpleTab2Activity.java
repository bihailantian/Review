...
public class SimpleTab2Activity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_simple_tab2);
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                if (tabId.equals("tab1")) { //第一个标签
                    Toast.makeText(SimpleTab2Activity.this, "点击标签页一", Toast.LENGTH_SHORT).show();
                }
                if (tabId.equals("tab2")) { //第二个标签
                    Toast.makeText(SimpleTab2Activity.this, "点击标签页二", Toast.LENGTH_SHORT).show();
                }
                if (tabId.equals("tab3")) { //第三个标签
                    Toast.makeText(SimpleTab2Activity.this, "点击标签页三", Toast.LENGTH_SHORT).show();
                }
