...
import com.xxm.review.view.ScaleProgressView;

public class ScaleProgressViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scale_progress_view);
