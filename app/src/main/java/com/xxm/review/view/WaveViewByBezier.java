...
public class WaveViewByBezier extends View {
    ...
    private final static String TAG = WaveViewByBezier.class.getSimpleName();
    ...
    public WaveViewByBezier(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        */
        ...
        Log.d(TAG, "mWaveCount=" + mWaveCount);
    }
    ...
    private void drawSinPath(Canvas canvas) {
        ...
        // TODO: 相信很多人会疑惑为什么控制点的纵坐标是以下值,是根据公式计算出来的,具体计算方法情况文章内容
